...
//		DC Environment
        keyStoreParameters.setResource("apps-ocp-drc-hanabank-co-id-chain.jks");
        
//      DEV Environment
//		keyStoreParameters.setResource("apps-ocp-dev-hanabank-co-id-chain.jks");
        keyStoreParameters.setPassword("redhat123");

        KeyManagersParameters keyManagersParameters = new KeyManagersParameters();
        keyManagersParameters.setKeyStore(keyStoreParameters);
        keyManagersParameters.setKeyPassword("redhat123");
